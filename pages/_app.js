...
<Link href={`${username?'/home':'/'}`} passHref={true}><span className="cursor-pointer text-lg font-medium text-blue-700 flex handwriting">Scrawlo</span></Link>
  ...
  user && (<>
   ...
   <Link href={`/${username}/scrawl`} passHref={true}><span className="mr-4 md:mr-6 cursor-pointer hidden md:flex hover:text-blue-700"><IconEdit/><span className=" hidden md:flex">&nbsp;Edits</span></span></Link>
