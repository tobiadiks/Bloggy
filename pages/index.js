...
<Link href="/" passHref={true}><span className="bg-gray-900 text-white p-2 text-center rounded-md">Launch For <b>FREE</b></span></Link>
{/* /profile to / */}
</div>

<div className="md:pl-42 md:pr-42 xl:pl-48 xl:pr-48 flex md:flex-row flex-col mt-10 justify-center align-middle">
